...
def get_alpha_for_kmax(kmax):
    # Define discrete values of alpha based on kmax
    alpha_values = {
        256: 0.0001,  # Alpha value for kmax = 256
        128: 0.0002,  # Alpha value for kmax = 128
        64:  0.0004,  # Alpha value for kmax = 64
        32:  0.0008   # Alpha value for kmax = 32
        }
    return alpha_values.get(kmax, 0.001)  # Default alpha if kmax is not found
